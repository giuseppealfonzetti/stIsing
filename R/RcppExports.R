...
#' @export
isingGraph3 <- function(DATA, HOLDOUT, THETA_INIT, CONSTRAINTS, MAXT, BURN, STEPSIZE, NU, METHODFLAG, SCALEVEC, SEED = 123L, VERBOSEFLAG = FALSE, HOLDOUTFLAG = FALSE, PAR1 = 1, PAR2 = 1, PAR3 = .75, SAMPLING_WINDOW = 1L, EACH = 1L, EACHCLOCK = 100L, STEPSIZEFLAG = 1L) {
