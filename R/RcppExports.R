...
#' @export
isingGraph <- function(DATA, THETA_INIT, CONSTRAINTS, MAXT, BURN, STEPSIZE, NU, METHODFLAG, SEED = 123L, VERBOSEFLAG = FALSE) {
    .Call(`_stIsing_isingGraph`, DATA, THETA_INIT, CONSTRAINTS, MAXT, BURN, STEPSIZE, NU, METHODFLAG, SEED, VERBOSEFLAG)
}
